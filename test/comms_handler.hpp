#ifndef SAM_MK_TEMPERATURE_SENSOR_COMMS_HANDLER_HPP_
#define SAM_MK_TEMPERATURE_SENSOR_COMMS_HANDLER_HPP_
...
namespace sam_mk {
    enum class ConnectionState : int { NOTCONNECTED = 0, CONNECTED = 1, ERROR = 2 };
